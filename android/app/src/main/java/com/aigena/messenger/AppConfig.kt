...
object AppConfig {
    const val BASE_URL = "http://192.168.0.24:5001/"
    const val REMOTE_URL = "https://john-super-server-1.tailc42499.ts.net/"
    const val API_TOKEN="f2qXS558EXJmXpQg5qEqBfcp1gfsqwbkP9Hm44p1BDw"
